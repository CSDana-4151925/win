...
<body>
     ...
     <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
        ...
        <h1 class="display-4 fw-normal">اربح مع دانه </h1>
        <p class="lead fw-normal">باقي على فتح التسجيل</p>
        <div id="demo"><div id="demo"> </div> </div>
        <p class="lead fw-normal">للسحب على  نسخةمجانيةمن تطبيقنا</p>
      </div>
      <div class="container">
          <ul class="list-group">
          <li class="list-group-item list-group-item-danger" aria-current="true"> <b>مقالات هامة </b> </li>
          <li class="list-group-item">مقالة جديدة 1</li>
          <li class="list-group-item">مقالة جديدة 2</li>
          <li class="list-group-item">مقالة جديدة 3</li>
          <li class="list-group-item">مقالة جديدة  4</li>
          </ul>
      </div>
     </div>
    ...
    <div class="d-grid gap-2 col-6 mx-auto my-5">
      <button id="winner" type="button" class="btn btn-info" >
        اختار الرابح
      </button>
    </div>
